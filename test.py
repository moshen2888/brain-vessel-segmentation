...
#net.evaluate(x=X, y=Y, steps=epochs, batch_size=10, shuffle=True)
val_loss, val_dice = net.evaluate_generator(generator=My_Custom_Generator(file_names_train, label_names_train, batch_size), steps=len(file_names_train)//batch_size, verbose=1)

print(f"validation loss: {val_loss:.4f}")
print(f"validation accuracy: {val_dice:.4f}")
