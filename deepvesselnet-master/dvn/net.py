...
class Network(object):
    ...
    def _fit_generator(self, generator, model, **kwargs):
        return self.models[model].fit_generator(generator, **kwargs)

    def fit_generator(self, generator, model, **kwargs):
    ...
    def _predict_generator(self, generator, model, **kwargs):
        return self.models[model].predict_generator(generator, **kwargs)

    def predict_generator(self, generator, model, **kwargs):
        kwargs['generator'] = generator
        kwargs['model'] = model
        return self._predict_generator(**kwargs)
    ...
    def _evaluate_generator(self, generator, model, **kwargs):
        return self.models[model].evaluate_generator(generator, **kwargs)

    def evaluate_generator(self, generator, model, **kwargs):
        kwargs['generator'] = generator
        kwargs['model'] = model
        return self._evaluate_generator(**kwargs)
